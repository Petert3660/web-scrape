...
public class WebScrapeHelper {
    ...
    public ArrayList<Product> scrapeTargetData(String url) throws IOException {
        ...
        while ((inputLine = in.readLine()) != null) {
            if (inputLine.contains("productInfo")) {
                analyseForUrlInformation(allProducts, in);
            }
        }
        in.close();
    ...
    private void analyseForUrlInformation(ArrayList<Product> allProducts, BufferedReader in) throws IOException {
        String input = "";
        do {
            input = in.readLine();
    ...
    private Product getProductDetails(String revisedUrl) throws IOException {
        ...
        String inputLine;
        while ((inputLine = in.readLine()) != null) {
            analyseForProductData(product, in, inputLine);
        }
        in.close();
    ...
    private void analyseForProductData(Product product, BufferedReader in, String inputLine) throws IOException {
